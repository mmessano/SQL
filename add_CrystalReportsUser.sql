...
select @cmd =		' USE [' + @dbname + ']' + char(13) +
					' IF  EXISTS (SELECT * FROM dbo.sysusers WHERE name = N''CrystalReportsUser'')' + char(13) +
					' EXEC dbo.sp_revokedbaccess N''CrystalReportsUser''' + char(13) +
					' EXEC dbo.sp_grantdbaccess @loginame = N''CrystalReportsUser'', @name_in_db= N''CrystalReportsUser''' + char(13) +
					' EXEC sp_addrolemember N''WebSiteUsers'', N''CrystalReportsUser''' + char(13)-- +
					--' GO ' + char(13)
