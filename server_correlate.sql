...
SELECT top 100 percent s.server_id, s.server_name, st.account, st.app_name, st.working_dir, st.comment, st.creator, st.trigger_string 
from	dbo.t_server s INNER JOIN 
...
truncate table t_websites

SELECT top 100 percent s.server_name, e.environment_name, ws.*
